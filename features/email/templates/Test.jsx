...
import { Html, Head, Tailwind, Heading, Text, Section, Preview, Container } from "@react-email/components";

export default function OtpEmail({ otpCode = "012345", userName = "Kullanıcı" }) {
    return (
        <Html>
            <Head>
                ...
                <Container className="bg-gray-50 py-12">
                    <Section className="bg-white p-8 rounded-lg shadow-md max-w-md mx-auto font-helvetica">
                        ...
                        <Text className="text-center text-lg mb-2">
                            Hesabınıza güvenli giriş yapabilmeniz için tek kullanımlık doğrulama kodunuz aşağıdadır.
                        </Text>
                        ...
                        <Text className="text-center text-xs text-gray-500 mb-2">
                            Bu kodu giriş ekranında ilgili alana girerek işleminizi tamamlayabilirsiniz. Kodunuz 10 dakika boyunca geçerlidir.
                        </Text>
                        <Text className="text-center text-xs text-gray-500 mb-2">
                            Eğer bu işlemi siz başlatmadıysanız, lütfen bu e-postayı dikkate almayınız ve hesabınızın güvenliğinden emin olun.
                        </Text>
