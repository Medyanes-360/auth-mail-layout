...
import { Html, Head, Tailwind, Heading, Text, Section, Preview } from "@react-email/components";
            ...
            <Tailwind>
                <Section className="bg-white p-8 rounded shadow-md max-w-md mx-auto font-helvetica">
                    ...
                    <Text className="text-center text-lg mb-2">
                        Medyanes ailesine katıldığınız için çok mutluyuz. Size en iyi deneyimi sunmak için buradayız.
                    </Text>
                    ...
                    <Text className="text-center text-sm text-gray-500 mt-4">
                        Keyifli kullanımlar dileriz!<br/>Medyanes Ekibi
                    </Text>
                </Section>
            </Tailwind>
        </Html>
